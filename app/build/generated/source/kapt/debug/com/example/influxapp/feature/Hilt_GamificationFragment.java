 ...
 */
public abstract class Hilt_GamificationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GamificationFragment() {
    super();
  }

  Hilt_GamificationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GamificationFragment_GeneratedInjector) this.generatedComponent()).injectGamificationFragment(UnsafeCasts.<GamificationFragment>unsafeCast(this));
    }
  }
