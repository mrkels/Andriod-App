 ...
 */
public abstract class Hilt_InsightAnalyticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InsightAnalyticsFragment() {
    super();
  }

  Hilt_InsightAnalyticsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InsightAnalyticsFragment_GeneratedInjector) this.generatedComponent()).injectInsightAnalyticsFragment(UnsafeCasts.<InsightAnalyticsFragment>unsafeCast(this));
    }
  }
