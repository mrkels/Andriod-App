 ...
 */
public abstract class Hilt_AddBudgetFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddBudgetFragment() {
    super();
  }

  Hilt_AddBudgetFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddBudgetFragment_GeneratedInjector) this.generatedComponent()).injectAddBudgetFragment(UnsafeCasts.<AddBudgetFragment>unsafeCast(this));
    }
  }
