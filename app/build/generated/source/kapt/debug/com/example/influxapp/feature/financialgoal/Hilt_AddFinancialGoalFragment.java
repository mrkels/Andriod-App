 ...
 */
public abstract class Hilt_AddFinancialGoalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddFinancialGoalFragment() {
    super();
  }

  Hilt_AddFinancialGoalFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddFinancialGoalFragment_GeneratedInjector) this.generatedComponent()).injectAddFinancialGoalFragment(UnsafeCasts.<AddFinancialGoalFragment>unsafeCast(this));
    }
  }
