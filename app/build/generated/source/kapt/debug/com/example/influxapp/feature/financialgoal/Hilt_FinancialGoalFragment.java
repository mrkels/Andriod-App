 ...
 */
public abstract class Hilt_FinancialGoalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FinancialGoalFragment() {
    super();
  }

  Hilt_FinancialGoalFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FinancialGoalFragment_GeneratedInjector) this.generatedComponent()).injectFinancialGoalFragment(UnsafeCasts.<FinancialGoalFragment>unsafeCast(this));
    }
  }
